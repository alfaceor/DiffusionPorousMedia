...
################## INPUT PARAMETERS ##################
strF2B = "1.0" 
strB2FList = ["0.001" ]#["0.000001", "0.00001", "0.0001", "0.001", "0.01", "0.1", "1.0" ] 
...
for b2f in range(len(strB2FList)):
  ...
  axR2.set_title("(b) $ p_{D} = "+lblB2F+" $"+", $R_H = "+strHrad+"$")
  ...
  leg = axR2.legend(handles[::-1], labels[::-1], bbox_to_anchor=(0.02,0.35), loc="lower left", title="$p_{S}$", prop={'size':12}, frameon=False)
  #figs[b2f].savefig("MSD_vs_t__pBF_"+strB2F +"__Hrad_"+strHrad+".pdf")
  figs[b2f].savefig("Fig2b.pdf")
  figs[b2f].savefig("Fig2b.eps")
