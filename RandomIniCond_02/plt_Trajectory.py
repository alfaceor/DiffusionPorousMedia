...
dataTraj = dataTraj[100000:500000]
...
mlab.plot3d(x, y, z, s, tube_radius=0.25, color=(1,0,0)) # colormap='Reds'#, representation='points')
mlab.points3d(x[-1], y[-1], z[-1] , mode='sphere', color=(0,0,1)) 
